...
- Credentials needed for integration:
  ...
  - Prepare your own Sandbox Private & Public Key. To generate your private key and public key, please follow this [link](/api-reference/introduction-1)
...
[Resources for Access Token Handling](/api-reference/introduction#credential-setup)
