...
- Credentials needed for integration:
  ...
  - Prepare your own Sandbox Private & Public Key. To generate your private key and public key, please follow this [link](/api-reference/authentication#credential-setup)
...
[Link for Access Token Handling](/api-reference/authentication#generate-signature-to-obtain-access-token-b2b)

### Signature Handling

[Link for Access Token Handling](/api-reference/authentication#generate-signature-for-transactional-api)

## Error Handling and Edge Cases

### Response Code List
[Link for Access Token Handling](/api-reference/authentication)
